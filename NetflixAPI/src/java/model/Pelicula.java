...
public class Pelicula {
    ...
    public Pelicula(String titulo, String trailer, String sinopsis, String fechaEstreno, String url, int duracion, int nVotos, int sPuntuacion, int id, Double precio) {
        this.titulo = titulo;
